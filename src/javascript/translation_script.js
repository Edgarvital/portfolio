...
const translations = {
    "pt-br": {
        ...
        description: `
            ...
            Na Overdrive Software e Consultoria, atuei no time de produtos internos. Iniciei desenvolvendo o back-end de sistemas utilizando Laravel (PHP) e posteriormente expandi minhas habilidades com .NET (C#). Depois, foquei no desenvolvimento mobile com Flutter (Dart), criando e mantendo aplicações robustas, incluindo um jogo que demonstra minha habilidade em atender demandas inovadoras.<br>
    ...
    "en": {
        ...
        description: `
            ...
            At Overdrive Software and Consulting, I worked on the internal products team. I started by developing the back-end of systems using Laravel (PHP) and later expanded my skills with .NET (C#). After that, I focused on mobile development with Flutter (Dart), creating and maintaining robust applications, including a game that demonstrates my ability to meet innovative demands.<br>
